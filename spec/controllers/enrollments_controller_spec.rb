  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved enrollment as @enrollment" do
        ...
        post :create, {:enrollment => { "user_id" => "invalid value" }}, valid_session
        expect(assigns(:enrollment)).to be_a_new(Enrollment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested enrollment" do
        ...
        expect_any_instance_of(Enrollment).to receive(:update).with({ "user_id" => "1" })
        put :update, {:id => enrollment.to_param, :enrollment => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the enrollment as @enrollment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Enrollment).to receive(:save).and_return(false)
        put :update, {:id => enrollment.to_param, :enrollment => { "user_id" => "invalid value" }}, valid_session
        expect(assigns(:enrollment)).to eq(enrollment)
      end
