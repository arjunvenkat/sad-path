  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved check as @check" do
        ...
        allow_any_instance_of(Check).to receive(:save).and_return(false)
        post :create, {:check => { "description" => "invalid value" }}, valid_session
        expect(assigns(:check)).to be_a_new(Check)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested check" do
        ...
        expect_any_instance_of(Check).to receive(:update).with({ "description" => "MyString" })
        put :update, {:id => check.to_param, :check => { "description" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the check as @check" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Check).to receive(:save).and_return(false)
        put :update, {:id => check.to_param, :check => { "description" => "invalid value" }}, valid_session
        expect(assigns(:check)).to eq(check)
      end
